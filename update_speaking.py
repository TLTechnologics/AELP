                ...
                <div className="bg-brand-dark rounded-[24px] p-6 shadow-md border border-brand-dark/20 relative overflow-hidden text-white">
                  ...
                  <div className="mt-8 flex items-center gap-4">
                    <button 
                      ...
                      className="w-14 h-14 bg-brand-yellow rounded-full flex items-center justify-center text-brand-dark hover:scale-105 transition-transform"
                    >
                      {isPlaying ? <Pause className="w-6 h-6 fill-brand-dark" /> : <Play className="w-6 h-6 fill-brand-dark ml-1" />}
                    </button>
                    <div className="flex-1">
                      {/* Audio element will go here, hidden */}
                      ...
                      <div className="flex items-center gap-1 h-8">
                        {[...Array(20)].map((_, i) => (
                          <motion.div
                            ...
                            className="flex-1 bg-brand-yellow/80 rounded-full"
                          />
                        ))}
                      </div>
