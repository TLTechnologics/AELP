...
export default function ProfilePage() {
  ...
  return (
    <>
      {loading && <LiquidLoader isLooping />}
      <MainLayout>
        {showPasswordModal && (
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="show"
        className={`max-w-5xl mx-auto space-y-8 pb-24 ${loading ? 'blur-sm opacity-50 pointer-events-none select-none transition-all duration-300' : 'transition-all duration-300'}`}
      >
